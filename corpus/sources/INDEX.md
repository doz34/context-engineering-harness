# Corpus — Index of primary sources (2025-2026)

> **Date of compilation**: 2026-06-08
> **Methodology**: WebSearch + WebFetch on Anthropic, LangChain, Morph, FlowHunt, HumanLayer, Addy Osmani, ICLR/arXiv, LangChain, MemGPT/Letta, Mem0, Cloudflare, etc.
> **Total**: 40+ primary or secondary sources of high quality.

## Tier 1 — Primary sources (papers + official blogs)
...
2. **Code Execution with MCP** (2025-11) — https://www.anthropic.com/engineering/code-execution-with-mcp
   - 98.7% economy of tokens vs tool calling direct
   - 150K → 2K tokens for tools
...
12. **GEPA — Reflective Prompt Evolution** (arXiv 2507.19457) — https://arxiv.org/abs/2507.19457
    - +12% on AIME-2025, outperforms MIPROv2 by 10%
...
18. **Morph — Context Rot: Why LLMs Degrade as Context Grows** (2026-03-13) — https://www.morphllm.com/context-rot
    - Chroma 18/18 study, 30% lost-in-middle, 35min wall, 60% retrieval, FlashCompact
19. **FlowHunt — Multi-Agent AI Systems in 2026: What the Research Actually Says** (2026-04-28) — https://www.flowhunt.io/blog/multi-agent-ai-system/
...
22. **Mem0 — 2026 Token Optimization Playbook** (2026) — https://mem0.ai/blog/the-2026-token-optimization-playbook-cut-ai-agent-memory-costs-3%25E2%2580%25934x
    - 3-4× reduction cost memory
23. **Cloudflare — Code Mode + MCP** (2025) — referenced by Anthropic
    - Code-as-API pattern
24. **Simon Willison — Code execution with MCP** (2025-11-04) — https://simonwillison.net/2025/Nov/4/code-execution-with-mcp/
    - Critical synthesis of Anthropic code execution

## Tier 2 — Secondary sources (analyses, comparisons, benchmarks)
...
## Tier 3 — Articles/blogs cited in proxy

- **Cognition Labs — Don't Build Multi-Agents (Jun 2025)** and **Devin can now Manage Devins (Mar 2026)** — synthesis via FlowHunt
- **Drew Breunig** — 4 failure modes (poisoning, distraction, confusion, clash) — cited in LangChain
- **Karpathy** — "LLM is CPU, context is RAM" — OS metaphor
...
## Summary of evolution 2025 → 2026

| Concept | Emergence | 2026 Maturity |
|---------|-----------|----------------|
| Context Engineering (term) | 2025 Q1 (Cognition) | Mainstream |
| Multi-agent + context isolation | 2025 Q2 (Anthropic) | Production |
| Compaction + scratchpad | 2025 Q3 (Anthropic cookbook) | Standard |
| RAG vs Long Context debate | 2025 Q4 (LightOn) | Complementary |
| **Agentic Context Engineering (ACE)** | **2025 Q4 (paper) → 2026 ICLR** | **New paradigm** |
| **Harness engineering** (term) | **2025 Q4 (Viv Trivedy)** | **Standard** |
| **Code-as-API / Code Mode** | **2025 Q4 (Anthropic + Cloudflare)** | **Rapid adoption** |
| **Self-evolving contexts** | **2026 ICLR (ACE)** | **Research frontier** |
| Memory as Action | 2026 ACL | Frontier |

## Cross-source synthetic findings

See `../findings/00-synthesis.md` (to be completed in Phase 2).

## Confirmed anti-patterns (8)

See `../anti-patterns/INDEX.md` (to be completed in Phase 2).
